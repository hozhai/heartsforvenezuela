<script lang="ts">
	...
	import family_photo from '$lib/images/h4v/family_2.webp?enhanced';
	import family_photo_2 from '$lib/images/h4v/family_1.webp?enhanced';
	import gifts_photo from '$lib/images/h4v/gifts_4.webp?enhanced';
	import activity_photo from '$lib/images/h4v/family_12.webp?enhanced';
...
<section class="bg-amber-50 px-48 py-18">
	<h1 class="font-display text-6xl">
		<span class="underline">H</span>ow to help! <span class="text-7xl text-red-400">&lt;3</span>
	</h1>
